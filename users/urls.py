...
from .views import RegisterView, LoginView, UserMeView, UserDetailView, CandidateProfileView, CandidateProfileDetailView, EmployerProfileView, EmployerProfileDetailView, EmployerListView
