...
from .views import RegisterView, LoginView, LogoutView, UserMeView, UserDetailView, CandidateProfileView, CandidateProfileDetailView, EmployerProfileView, EmployerProfileDetailView, EmployerListView
